...
def motion(win):
    ...
    #anchor
    r=5
    cvs.create_oval(4.13*scale+X0-r,0*scale-r+Y0,4.13*scale+X0+r,0*scale+r+Y0, fill='black', width=2)
    cvs.create_oval(0*scale+X0-r,0*scale-r+Y0,0*scale+X0+r,0*scale+r+Y0, fill='black', width=2)
    cvs.create_oval(3.22*scale+X0-r,-6.56*scale-r+Y0,3.22*scale+X0+r,-6.56*scale+r+Y0, fill='black', width=2)
    cvs.create_oval(-0.08*scale+X0-r,-6.14*scale-r+Y0,-0.08*scale+X0+r,-6.14*scale+r+Y0, fill='black', width=2)
    while True:
        try:
   ...
   # rotate image by 30 degrees
        ...
        cvs.create_oval(car2[0][0]-2,car2[0][1]-2,car2[0][0]+2,car2[0][1]+2, fill="green") 
