...
while(True):
    ...
    uyt.append(uy)
    if i>=4305:
        xxx=int(1856-uy*20.5)
        yyy=int(550-25*ux)            
       
    elif i>=4005:
        xxx=int(1800-uy*19.5)
        yyy=int(570-25*ux)
    ...
    for i in range(len(uxt)):
        ...
        try:
            if i>=4305:
                ...
                cv2.line(img1, (int(1856-uyt[i]*20.5) , int(550-25*uxt[i])), (int(1856-uyt[i]*20.5), int(550-25*uxt[i])), (255, 0,0), 3)
            elif i>=4005:
                
                cv2.line(img1, (int(1800-uyt[i]*19.5) , int(570-25*uxt[i])), (int(1800-uyt[i]*19.5), int(570-25*uxt[i])), (255, 0,0), 3)
            elif i>=2225:
                
                cv2.line(img1, (int(1800-uyt[i]*19.5) , int(570-20.7*uxt[i])), (int(1800-uyt[i]*19.5), int(570-20.7*uxt[i])), (255, 0,0), 3)
            elif i>1800:
                cv2.line(img1, (int(1800-uyt[i]*19.2) , int(570-20.7*uxt[i])), (int(1800-uyt[i]*19.2), int(570-20.7*uxt[i])), (255, 0,0), 3)
            elif i>1000:
                cv2.line(img1, (int(1800-uyt[i]*19) , int(570-20.7*uxt[i])), (int(1800-uyt[i]*19), int(570-20.7*uxt[i])), (255, 0,0), 3)
                            
            else:
                cv2.line(img1, (int(1800-uyt[i]*18.3) , int(570-20.7*uxt[i])), (int(1800-uyt[i]*18.3), int(570-20.7*uxt[i])), (255, 0,0), 3) 
        except:
            continue 
